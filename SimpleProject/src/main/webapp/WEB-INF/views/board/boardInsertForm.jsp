...
<body>
	...
	<form action="${context}/board/boardInsert" method="post" name="insertBoardForm"  class="form-horizontal">
	...
	<div class="text-center">
		<input type="button" class="btn btn-primary" value="글쓰기" onclick="writeBoard()"/>
	</div>
	<footer class="footer">
		<div class="container">
